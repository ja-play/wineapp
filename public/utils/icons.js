/**
 * Reusable SVG Icons for Aurellion Wine Application
 * Defines SVG icon paths and helper renderer.
 */

export const ICONS = {
  wine: `<path stroke-linecap="round" stroke-linejoin="round" d="M8 22h8M12 15v7M5 3h14v4a7 7 0 0 1-14 0V3z"/>`,
  wineGlass: `<path d="M8 22h8"></path><path d="M12 15v7"></path><path d="M12 15a7 7 0 0 0 7-7c0-2-1-3.5-2.5-4.5h-9C6 4.5 5 6 5 8a7 7 0 0 0 7 7z"></path><path d="M7 3.5 12 7l5-3.5"></path>`,
  printer: `<path stroke-linecap="round" stroke-linejoin="round" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4H7v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"/>`,
  check: `<path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/>`,
  checkCircle: `<path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>`,
  ...
  errorCircle: `<path stroke-linecap="round" stroke-linejoin="round" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/>`,
  ...
  barcode: `<path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-16v16M4 4v16m4-16v16m8-16v16"/>`,
  box: `<path stroke-linecap="round" stroke-linejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>`,
  truck: `<path stroke-linecap="round" stroke-linejoin="round" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z"/><path stroke-linecap="round" stroke-linejoin="round" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h2"/>`,
  ...
  fileText: `<path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>`,
 ...
 * @param {string} name - Name of the icon in ICONS dictionary
 * @param {Object} [options] - Configuration options
 * @param {string} [options.className='w-5 h-5'] - Tailwind/CSS classes
 * @param {string} [options.strokeWidth='2'] - SVG stroke width
 * @param {string} [options.viewBox='0 0 24 24'] - SVG viewBox
 * @returns {string} Safe SVG markup string
 */
export function getIcon(name, { className = 'w-5 h-5', strokeWidth = '2', viewBox = '0 0 24 24', extraAttrs = '' } = {}) {
  const path = ICONS[name] || ICONS.wine;
  return `<svg class="${className}" fill="none" stroke="currentColor" stroke-width="${strokeWidth}" viewBox="${viewBox}" ${extraAttrs}>${path}</svg>`;
}

// Make globally accessible for inline template literals
if (typeof window !== 'undefined') {
  window.AppIcons = { getIcon, ICONS };
}
